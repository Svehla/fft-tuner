...
const main = async () => {
  ...
  if (useMockChord) {
    ...
    const conf = {
      ...
      audio_block_size: 1024, //// 1024 * 2, // 1024, // *2*2, // number of samples for one block of FFT // i guess this is sliding window for analyzing partial parts of fft
...
export const App = () => {
  ...
  return (
    <div>
      ...
      <p>
        A short audio fragment is downloaded and sliced into audio blocks. FFT
        magnitudes are calculated for each block with the SIMD WASM version of{" "}
        <b>pffft</b>. Note that a Hamming window is applied automatically by
        default. Next, magnitudes are visualized using a spectrogram placed on a{" "}
        <b>canvas</b> element. Time is on the horizontal axis and frequency (Hz)
        on the vertical.
      </p>
      <p>
        Note that{" "}
        ...
        needs to be configured correctly to make this demo work. A working
        configuration sets these headers:
      ...
      <div style={{ flexDirection: "column" }}>
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <audio
            src="http://localhost:8003/181425__serylis__guitar-chord.wav"
            controls
          ></audio>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          g_sharp_chord
          <audio
            src="http://localhost:8003/assets/g_sharp_chord.wav"
            controls
          ></audio>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          f_major_chord
          <audio
            src="http://localhost:8003/assets/f_major_chord.wav"
            controls
          ></audio>
        </div>
